 ...
 * particular, it extends the chain in [[com.amazonaws.auth.DefaultAWSCredentialsProviderChain]] with the retrieval of
 * AWS credentials through the default typesafe configuration file (typically application.conf).
 */
