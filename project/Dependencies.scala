...
object Dependencies {
  ...
  val Specs2Common_4         = "org.specs2"                 %% "specs2-common"             % Versions.Specs2_4
  val Specs2Common_5         = "org.specs2"                 %% "specs2-common"             % Versions.Specs2_5
  val Specs2Core_4           = "org.specs2"                 %% "specs2-core"               % Versions.Specs2_4
  val Specs2Core_5           = "org.specs2"                 %% "specs2-core"               % Versions.Specs2_5
  val Specs2JUnit_4          = "org.specs2"                 %% "specs2-junit"              % Versions.Specs2_4
  val Specs2Matcher_4        = "org.specs2"                 %% "specs2-matcher"            % Versions.Specs2_4
  val Specs2Matcher_5        = "org.specs2"                 %% "specs2-matcher"            % Versions.Specs2_5
  val Specs2ScalaCheck_4     = "org.specs2"                 %% "specs2-scalacheck"         % Versions.Specs2_4
